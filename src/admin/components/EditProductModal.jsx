    ...
    useEffect(() => {
        if (product) {
            setFormData({
                ...
                date: product.date || "2024-03-29",
                description: product.description || "",
                visibility: product.visibility || "Published",
                scheduleDiscount: product.scheduleDiscount || true,
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:row-span-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {formData.images.length > 0 ? (
                                formData.images.map((img, i) => (
                                    <div key={i} className="border rounded p-2 flex justify-center items-center h-28 bg-gray-50">
                                        <img
                                            src={img}
                                            alt={`preview-${i}`}
                            ...
                            {Array.from({ length: 4 - formData.images.length }).map((_, i) => (
                                <div
                                    key={i}
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Add at least 4 images. 1 can be a video. Make sure your photo has the best quality.
                        </p>
                    </div>
